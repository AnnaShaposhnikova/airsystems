                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        Приєднувальний <br />розмір,<br />дюйм
                                    </th>
                                    <th>Розміри, мм</th>
                                    <th>Ресивер, lt</th>
                                    <th>Вага, кг</th>
            ...
            <div class="row mb-5">
                <div class="col">
                    <ul>
                        ...
                        <li>
                            Надійний корпус, розроблений відповідно до норм СЕ
                        </li>
                        <li>
                            Повітряний ресивер зі стандартною місткістю 500 л
                        </li>
                        <li>
                        ...
                        <li>
                            Гідравлічні шланги, стійкі до високого тиску та
                            тепла
                        </li>
                    </ul>
                </div>
        ...
        <article>
            <div class="row">
                <div class="col">
                    ...
                    <p class="indent">
                        Кришку можна повністю підняти, забезпечуючи легкий
            ...
            <div class="row mb-5">
                <div class="col">
                    <ul>
                        ...
                        <li>Низька вартість обслуговування</li>
                        <li>
                            Робота без вібрації з накладками для запобігання
                            вібрації
                        </li>
                        <li>
                            Легка експлуатація навіть в холодну погоду завдяки
                            термостатичному масляному клапану
                        </li>
                        <li>
                            Шафа захищена електростатичним порошковим покриттям
                            від корозії
                        </li>
